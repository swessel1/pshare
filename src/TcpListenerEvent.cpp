...
TcpListenerEvent::TcpListenerEvent(EventRegistrar &orig,
                                   void *data,
                                   TcpListenerEvent::Flags flag) :
    Event(orig), data(data), flag(flag) { }

TcpListenerEvent::Flags TcpListenerEvent::get_flag() const {
